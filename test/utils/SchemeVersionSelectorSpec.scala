...
class SchemeVersionSelectorSpec extends AnyWordSpecLike with Matchers {
  ...
  "getSchemeVersion" should {
    ...
    "return All when passed true for useV4andV5Scheme and useV6andV7Scheme" in {
    ...
    "return V4andV5 when passed true for useV4andV5Scheme and false for useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(
        useV4andV5Scheme = true,
    ...
    "return V6andV7 when passed false for useV4andV5Scheme and true for useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(
    ...
    "return V4andV5 when passed false for useV4andV5Scheme and useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(
        useV4andV5Scheme = false,
        useV6andV7Scheme = false
      ) shouldBe SchemeVersion.V4andV5
