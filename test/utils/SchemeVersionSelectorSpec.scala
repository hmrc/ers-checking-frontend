...
class SchemeVersionSelectorSpec extends AnyWordSpecLike with Matchers {
  ...
  "getSchemeVersion" should {
    ...
    "return All when parsed true for useV4andV5Scheme and useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(useV4andV5Scheme = true, useV6andV7Scheme = true) shouldBe SchemeVersion.All
    }

    "return V4andV5 when parsed true for useV4andV5Scheme and false for useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(useV4andV5Scheme = true, useV6andV7Scheme = false) shouldBe SchemeVersion.V4andV5
    }

    "return V6andV7 when parsed false for useV4andV5Scheme and true for useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(useV4andV5Scheme = false, useV6andV7Scheme = true) shouldBe SchemeVersion.V6andV7
    }

    "return V6andV7 when parsed false for useV4andV5Scheme and useV6andV7Scheme" in {
      SchemeVersionSelector.getSchemeVersion(useV4andV5Scheme = false, useV6andV7Scheme = false) shouldBe SchemeVersion
        .V4andV5
    }
  }
