...
class AuthorisationControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockitoSugar {
  val controllerComponents: MessagesControllerComponents = app.injector.instanceOf[MessagesControllerComponents]
  val mockAppConfig: ApplicationConfig = mock[ApplicationConfig]

  val authController: AuthorisationController = new AuthorisationController(controllerComponents, mockAppConfig)
