...
trait EMIHeaders {
  ...
  //EMI NonTaxable
  val emiXMLHeaderSheet4: Elem = <table:table-row table:style-name="ro15"><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>1.</text:p><text:p>Date of option exercise</text:p><text:p>(yyyy-mm-dd)</text:p></table:table-cell><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>2.</text:p><text:p>Employee first name</text:p></table:table-cell><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>3.</text:p><text:p>Employee second name</text:p><text:p>(if applicable)</text:p></table:table-cell><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>4.</text:p><text:p>Employee last name</text:p></table:table-cell><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>5.</text:p><text:p>National Insurance number</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>6.</text:p><text:p>PAYE reference of employing company</text:p></table:table-cell><table:table-cell office:value-type="string" table:content-validation-name="val8" table:style-name="ce3"><text:p>7.</text:p><text:p>Total number of shares employee entitled to on exercise of the option before any cashless exercise or other adjustment</text:p><text:p>e.g. 100.00</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>8.</text:p><text:p>Actual market value (AMV) of a share at the date of grant of the options exercised</text:p><text:p>£</text:p><text:p>e.g. 10.1234</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>9.</text:p><text:p>Exercise price per share</text:p><text:p>£</text:p><text:p>e.g. 10.1234</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>10.</text:p><text:p>AMV of a share at date of exercise</text:p><text:p>£</text:p><text:p>e.g. 10.1234</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>11.</text:p><text:p>Are the shares subject to the option exercised listed on a recognised stock exchange?</text:p><text:p>(yes/no)</text:p><text:p>If yes go to question 14</text:p><text:p>If no go to next question 12</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>12.</text:p><text:p>If no, was the market value agreed with HMRC?</text:p><text:p>(yes/no)</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>13.</text:p><text:p>If yes, enter the HMRC valuation reference given</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>14.</text:p><text:p>Total amount paid for shares</text:p><text:p>£</text:p><text:p>e.g. 10.1234</text:p></table:table-cell><table:table-cell office:value-type="string" table:style-name="ce3"><text:p>15.</text:p><text:p>Were all shares resulting from the exercise sold? (yes/no). Answer yes if they were either sold on the same day as the exercise in connection with the exercise or sale instructions were given for all shares to be sold on exercise</text:p></table:table-cell></table:table-row>
  val emiHeaderSheet4Data: List[String] = List(
