...
trait ERSValidationSIPOutTestData {// scalastyle:off magic.number
  val rowNumber:Int = 1
  ...
  def getDescriptions: List[String] = {
    val descriptions =
      List(
        ...
        "Return an error message when no PAYE reference is provided",
        //coluimn G
  ...
  def getValidRowData:Seq[Cell] = {
    val rowData = Seq(
      ...
      Cell("J", rowNumber, "12.12"),
      Cell("K", rowNumber, "12.1234"),
      Cell("L", rowNumber, "12.1234"),
      Cell("M", rowNumber, "12.1234"),
      Cell("N", rowNumber, "12.1234"),
      Cell("O", rowNumber, "no"),
      Cell("P", rowNumber, "no"),
      Cell("Q", rowNumber, "yes")
    )
