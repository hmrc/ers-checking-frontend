...
class StaxProcessorTests extends PlaySpec with StaxIntegrationTestData {
  "StaxProcessor" must {
    ...
    "return the first row of the table as xml" in {
      ...
      processor.hasNext
      processor.next()
      val ret = processor.next()
      ret must equal("<table:table-row table:style-name='ro5'><table:table-cell table:style-name='ce6' calcext:value-type='string'><text:p>4.</text:p></table:table-cell></table:table-row>")
    }
  }
}
