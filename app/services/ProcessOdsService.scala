...
@Singleton
class ProcessOdsService @Inject() (sessionCacheService: ErsCheckingFrontendSessionCacheRepository, ersUtil: ERSUtil)(
  ...
  def processSheetErrors(sheetErrors: ListBuffer[SheetErrors], errorCount: Int)(implicit
    request: Request[_]
  ): Future[Boolean] =
